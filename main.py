...
class CsvParserGui():
    ...
    def __init__(self):
        ...
        self.title_background_image = PhotoImage(file=r"C:\Users\phoeb\PycharmProjects\CSV-Parser\image_1.png")
        self.title_background = self.window.create_image(350.0, 41.0, image=self.title_background_image)

        self.title_image = PhotoImage(file=r"C:\Users\phoeb\PycharmProjects\CSV-Parser\image_2.png")
        self.title = self.window.create_image(237.0, 41.0, image=self.title_image)

        self.background_image = PhotoImage(file=r"C:\Users\phoeb\PycharmProjects\CSV-Parser\image_3.png")
        self.background = self.window.create_image(350.0, 291.0, image=self.background_image)

        self.generate_section_image = PhotoImage(file=r"C:\Users\phoeb\PycharmProjects\CSV-Parser\image_4.png")
        ...
        self.generate_button_image = PhotoImage(file=r"C:\Users\phoeb\PycharmProjects\CSV-Parser\button_2.png")
        ...
        self.select_section_image = PhotoImage(file=r"C:\Users\phoeb\PycharmProjects\CSV-Parser\image_5.png")
        self.select_section = self.window.create_image(350.0, 190.0, image=self.select_section_image)

        self.clear_button_image = PhotoImage(file=r"C:\Users\phoeb\PycharmProjects\CSV-Parser\button_3.png")
        ...
        self.browse_button_image = PhotoImage(file=r"C:\Users\phoeb\PycharmProjects\CSV-Parser\button_4.png")
        ...
        self.file_entry_image = PhotoImage(file=r"C:\Users\phoeb\PycharmProjects\CSV-Parser\entry_1.png")
